<h2><a href="https://www.geeksforgeeks.org/problems/type-conversion--151956/1?page=2&category=CPP&sortBy=submissions">Type Conversion</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a double value <strong>d</strong>, typecast it to an <strong>integer</strong> value and print it.</span></p>
